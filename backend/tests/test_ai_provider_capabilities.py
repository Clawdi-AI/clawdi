...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("https://provider.example/v1#", False),
        ("https://provider.example/v1;transport=responses", True),
        ("https://provider.example;port/v1", False),
        ("https://provider.internal/v1", False),
        ("https://provider.home.arpa/v1", False),
        ("https://provider.svc/v1", False),
        ("https://192.0.2.1/v1", False),
        ("https://224.0.0.1/v1", False),
