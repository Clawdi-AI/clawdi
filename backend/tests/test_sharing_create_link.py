...
@pytest.mark.asyncio
async def test_create_share_link_returns_raw_token_once(client, seed_user, seed_scope):
...
@pytest.mark.asyncio
async def test_create_share_link_persists_hash_not_raw(client, seed_user, seed_scope):
