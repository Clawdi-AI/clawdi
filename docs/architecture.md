...
| `hosted_runtime_config_observations` | Daemon-reported CONFIG convergence and validated diagnostics, including observed config generation and manifest/channels ETags; distinct from hosted provider COMPUTE observations. |
