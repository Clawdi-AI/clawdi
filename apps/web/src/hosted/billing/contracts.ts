...
export type WalletComputeActivateResponse = Schemas["V2WalletComputeActivateResponse"];
export type WalletComputeQuoteRequest = Schemas["V2WalletComputeQuoteRequest"];
export type WalletComputeQuoteResponse = Schemas["V2WalletComputeQuoteResponse"];
