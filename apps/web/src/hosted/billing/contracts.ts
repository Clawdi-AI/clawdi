...
export type OpenClawPairingApproveResponse = Schemas["V2OpenClawPairingApproveResponse"];
export type OpenClawPairingRequest = Schemas["V2OpenClawPairingRequest"];
export type OpenClawPairingRequestsResponse = Schemas["V2OpenClawPairingRequestsResponse"];
