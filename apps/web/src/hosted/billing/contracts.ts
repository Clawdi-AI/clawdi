...
export type WalletBinding = Schemas["V2WalletBindingResponse"];
export type WalletBindingChallengeRequest = Schemas["V2WalletBindingChallengeRequest"];
export type WalletBindingChallenge = Schemas["V2WalletBindingChallengeResponse"];
export type WalletBindingVerifyRequest = Schemas["V2WalletBindingVerifyRequest"];
export type X402TopupAttempt = Schemas["V2X402TopupAttemptResponse"];
