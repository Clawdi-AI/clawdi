...
KEEP_OPERATIONS_BY_PATH: dict[str, set[str]] = {
    ...
    "/v2/ai-providers/{provider_id}": {"delete"},
    "/v2/ai-providers/{provider_id}/removal-impact": {"get"},
    ...
    "/v2/deployments/{deployment_id}/workspace-skills/{skill_key}": {"get", "delete"},
